...
FglTFRuntimeParser::FglTFRuntimeParser(TSharedRef<FJsonObject> JsonObject, const FMatrix& InSceneBasis, float InSceneScale) : Root(JsonObject), SceneBasis(InSceneBasis), SceneScale(InSceneScale)
{
	...
	UMaterialInterface* OpaqueMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_glTFRuntimeBase"));
	if (OpaqueMaterial)
	{
		MetallicRoughnessMaterialsMap.Add(EglTFRuntimeMaterialType::Opaque, OpaqueMaterial);
	}

	UMaterialInterface* TranslucentMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_glTFRuntimeTranslucent_Inst"));
	if (TranslucentMaterial)
	{
		MetallicRoughnessMaterialsMap.Add(EglTFRuntimeMaterialType::Translucent, TranslucentMaterial);
	}

	UMaterialInterface* TwoSidedMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_glTFRuntimeTwoSided_Inst"));
	if (TwoSidedMaterial)
	{
		MetallicRoughnessMaterialsMap.Add(EglTFRuntimeMaterialType::TwoSided, TwoSidedMaterial);
	}

	UMaterialInterface* TwoSidedTranslucentMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_glTFRuntimeTwoSidedTranslucent_Inst"));
	...
	UMaterialInterface* MaskedMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_glTFRuntimeMasked_Inst"));
	if (MaskedMaterial)
	{
		MetallicRoughnessMaterialsMap.Add(EglTFRuntimeMaterialType::Masked, MaskedMaterial);
	}

	UMaterialInterface* TwoSidedMaskedMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_glTFRuntimeTwoSidedMasked_Inst"));
	...
	UMaterialInterface* SGOpaqueMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_glTFRuntime_SG_Base"));
	if (SGOpaqueMaterial)
	{
		SpecularGlossinessMaterialsMap.Add(EglTFRuntimeMaterialType::Opaque, SGOpaqueMaterial);
	}

	UMaterialInterface* SGTranslucentMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_glTFRuntime_SG_Translucent_Inst"));
	if (SGTranslucentMaterial)
	{
		SpecularGlossinessMaterialsMap.Add(EglTFRuntimeMaterialType::Translucent, SGTranslucentMaterial);
	}

	UMaterialInterface* SGTwoSidedMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_glTFRuntime_SG_TwoSided_Inst"));
	if (SGTwoSidedMaterial)
	{
		SpecularGlossinessMaterialsMap.Add(EglTFRuntimeMaterialType::TwoSided, SGTwoSidedMaterial);
	}

	UMaterialInterface* SGTwoSidedTranslucentMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_glTFRuntime_SG_TwoSidedTranslucent_Inst"));
	...
	// KHR_materials_unlit 
	UMaterialInterface* UnlitOpaqueMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_Unlit_glTFRuntimeBase"));
	if (UnlitOpaqueMaterial)
	{
		UnlitMaterialsMap.Add(EglTFRuntimeMaterialType::Opaque, UnlitOpaqueMaterial);
	}

	UMaterialInterface* UnlitTranslucentMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_Unlit_glTFRuntimeTranslucent_Inst"));
	if (UnlitTranslucentMaterial)
	{
		UnlitMaterialsMap.Add(EglTFRuntimeMaterialType::Translucent, UnlitTranslucentMaterial);
	}

	UMaterialInterface* UnlitTwoSidedMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_Unlit_glTFRuntimeTwoSided_Inst"));
	if (UnlitTwoSidedMaterial)
	{
		UnlitMaterialsMap.Add(EglTFRuntimeMaterialType::TwoSided, UnlitTwoSidedMaterial);
	}

	UMaterialInterface* UnlitTwoSidedTranslucentMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_Unlit_glTFRuntimeTwoSidedTranslucent_Inst"));
	...
	UMaterialInterface* UnlitMaskedMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_Unlit_glTFRuntimeMasked_Inst"));
	if (UnlitMaskedMaterial)
	{
		UnlitMaterialsMap.Add(EglTFRuntimeMaterialType::Masked, UnlitMaskedMaterial);
	}

	UMaterialInterface* UnlitTwoSidedMaskedMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_Unlit_glTFRuntimeTwoSidedMasked_Inst"));
	...
	UMaterialInterface* TrasmissionMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_Transmission_glTFRuntimeBase"));
	if (TranslucentMaterial)
	{
	...
	UMaterialInterface* TrasmissionTwoSidedMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/AvatarSDK/glTFRuntime/M_Transmission_glTFRuntimeTwoSided_Inst"));
